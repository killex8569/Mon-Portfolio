...
export const PROJECTS_DATA = [
    ...
    },
    {
      ...
      description : 'Participation à la coupe de france de robotique avec le club "Galiléo". Cette compétition à lieux à la roche sur Yon, nous avons du nous déplacer sur plusieurs jours pour pouvoirs participer, nous avons réaliser plusieurs projets. J\'ai notamment pu manipuler du C, C++ ainsi que tout ce qui touche au domaine de l\'éléctronique. Nous avons en équipe aussi utiliser ROS 2 qui est une platforme/outils de développement pour de la robotique.',
      status: 'en-cours',
      period: '2026',
