        ...
        <div class="footer-container">
            <div class="footer-row">
                ...
                <div class="footer-col">
                    ...
                    <ul className="footer-ul">
                        <li><a target="_blank" href="https://github.com/killex8569/Mon-Portfolio">Lien GitHub</a></li>
                ...
                <div class="footer-col">
                    ...
                    <ul className="footer-ul">
                        <li><a target="_blank" href="mailto:alexandre.faubladier.anette@gmail.com">alexandre.faubladier.anette@gmail.com</a></li>                        
